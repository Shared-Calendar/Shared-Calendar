...
public enum ErrorCode {
	...
	SELF_CONNECTION_REQUEST(HttpStatus.FORBIDDEN, "자기 자신에게는 초대를 받을 수 없습니다."),
	SELF_DISCONNECTION_REQUEST(HttpStatus.FORBIDDEN, "자기 자신에게는 삭제를 할 수 없습니다."),
	...
	NO_LOGIN_INFORMATION(HttpStatus.NOT_FOUND, "로그인 상태가 아닙니다."),
	...
	CONNECT_DUPLICATE(HttpStatus.CONFLICT, "이미 연결된 유저입니다.");
