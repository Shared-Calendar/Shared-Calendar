...
alter table NOTIFICATION_TB
    add foreign key (target_user_id) references USER_TB (id);
alter table NOTIFICATION_TB
    add foreign key (shared_schedule_id) references SHARED_SCHEDULE_TB (id);
alter table SHARED_SCHEDULE_TB
    add foreign key (user_id) references USER_TB (id);
alter table SHARED_SCHEDULE_TB
    add foreign key (connectee_id) references USER_TB (id);
alter table CONNECTOR_TB
    add foreign key (connector_id) references USER_TB (id);
alter table CONNECTOR_TB
    add foreign key (connectee_id) references USER_TB (id);